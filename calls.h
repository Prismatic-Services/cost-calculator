...
inline double driver_payment(const std::string& base_path, const std::string& driver_start_date){
    const std::vector<std::string> driver_payment_scale = readfilein(base_path + "Driver Payment Scale.csv");
...
inline std::vector<bus_metrics> bus_data(const std::string& base_path) {
    const std::vector<std::string> daily_bus_route_data = readfilein(base_path + "Daily Bus Routes.csv");
...
inline double pva(const std::string& base_path, const std::string& year, const int& row_count) {
    const std::vector<std::string> pva_table = readfilein(base_path + "PVA Table.csv");
    std::vector<std::vector<std::string>> reformatted_data;
...
inline double maintenance(const std::string& base_path, const int& row_count) {
    const std::vector<std::string> maintenance_payment_scale = readfilein(base_path + "Maintenance Payment Scale.csv");
...
inline double management(const std::string& base_path, const std::string& bus_approval_date, const std::string& category = "") {
    const std::vector<std::string> management_payment_scale = readfilein(base_path + "Management Payment Scale.csv");
...
inline std::vector<std::vector<std::string>> buses_and_drivers(const std::string& base_path) {
    const std::vector<std::string> file = readfilein(base_path + "Buses and Drivers.csv");
